export const TEMPLATE_DATA = [
  {
    ...
    features: [
      ...
      'System fonts for zero-latency typographic rendering',
      'Fully responsive pure monochrome CSS-grid architecture',
      'Automatic dark mode / light mode system detection',
      'Bypasses heavy JavaScript layout interventions'
    ]
  },
  {
    id: 'react-modern',
    ...
    features: [
      ...
      'Advanced structural glassmorphic UI surfaces',
      'Responsive native hover physics on repository cards',
      'Vibrant localized gradient ambient backgrounds',
      'Dynamic project layout architectures'
    ]
  },
  {
    id: 'vanilla-minimal',
    ...
    features: [
      'Instantaneous browser loading speeds',
      'No complex build pipelines required',
      'Fully responsive pure monochrome CSS-grid architecture',
      'Automatic dark mode / light mode system detection',
      '100% Native Web Standards'
    ]
  },
  {
    id: 'vanilla-modern',
    ...
    features: [
      ...
      'Responsive native hover physics on repository cards',
      'Vibrant localized gradient ambient backgrounds',
      'Extremely lightweight client payload'
    ]
  },
  {
    id: 'next-minimal',
  ...
  },
  {
    ...
    features: [
      ...
      'Scroll-triggered staggering entry animations via Client Components',
      'Advanced structural glassmorphic UI surfaces',
      'Responsive native hover physics on repository cards',
      'Vibrant localized gradient ambient backgrounds'
    ]
