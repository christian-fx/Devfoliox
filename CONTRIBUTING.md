...
First off, thank you for considering contributing to Devfolio! Whether you are submitting a new template architecture, fixing a bug in the CLI, or refining the documentation, your help is incredibly appreciated.
...
Devfolio templates and the core CLI engine rely on clean, modern JavaScript. Ensure your contributions adhere to the following constraints:
...
If you are adding a new portfolio template to the Devfolio generator:
...
When you are ready to merge your work back into the Devfolio ecosystem:
